...
using PlutoUI, SimilaritySearch, HypertextLiteral, LinearAlgebra, Plots, SimSearchManifoldLearning, Primes
...
# the results are better with Spectral layout, but spectral layout is too slow for the input-data's size
plot_umap(load_or_create_umap_embeddings(index; layout=RandomLayout(), k, n_epochs, neg_sample_rate=3)...)

# ╔═╡ b4d0850b-bb79-469a-b2d0-e13810d6b17f
plot_umap(load_or_create_umap_embeddings(index; layout=KnnGraphLayout(), k, n_epochs, neg_sample_rate=3)...)
