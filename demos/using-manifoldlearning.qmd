...
> **SimSearchManifoldLearning 0.4 note:** The `fit(Isomap, X, nntype=...)` API is unchanged;
> this release updates the `SimilaritySearch` v1.2 backend internally.
> `ApproxEuclidean`, `ApproxManhattan`, and `ApproxChebyshev` selectors work exactly as before.
